...
var EditorComponent = (function () {
    ...
    EditorComponent.prototype.exitEditingMode = function (event) {
        ...
        if (!(lastLogic.name.length && lastLogic.value.length) && !(this.customMode)) {
