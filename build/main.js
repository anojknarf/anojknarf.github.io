...
var ElementComponent = (function () {
    ...
    ElementComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'element',template:/*ion-inline-start:"/Office/Rule-Editor/src/components/element/element.component.html"*/'<div class="element-container">\n	<div class="element-label">{{elementObject.name}}</div>\n	<div *ngIf="elementObject.type == \'options\'" class="element-value type-dropdown" (click)="showDropdown = showDropdown ? false : true">\n		{{selectedValue.name}}\n		<div class="element-options" [ngClass]="showDropdown ? \'show\' : \'\'">\n			<div class="element-option" *ngFor="let opt of elementObject.options" (click)="selectedValue = opt">{{opt.name}}</div>\n		</div>\n	</div>\n	<input *ngIf="elementObject.type == \'number\'" (keypress)=\'numberRestrict(event)\' [(ngModel)]="selectedValue" class="element-value type-number">\n	<input *ngIf="elementObject.type == \'string\'" [(ngModel)]="selectedValue" class="element-value">\n</div>'/*ion-inline-end:"/Office/Rule-Editor/src/components/element/element.component.html"*/
        }),
...
var EditorComponent = (function () {
    ...
    EditorComponent.prototype.enterEditingMode = function (event) {
        console.log('enter enterEditingMode..', event);
    ...
    EditorComponent.prototype.getoperators = function () {
        ...
        console.log(this.operators[fieldType]);
